...
message.channel.send({embed})
  ...
  .addField ("Du salon :", "#" + message.channel.name)
	...
	if(command === "invite") {
		...
		const embed = new Discord.RichEmbed()
		.setColor("RANDOM")
	.addField ("Rejoindre le support :","<a:premium:605934130353537062>[Rejoindre Le support](https://discord.gg/a9QTEbb)")
       ...
       setTimeout (() => {
        ...
        if (reaction.emoji.name === "👪") {
            ...
            base.edit({ embed: {
              ...
              description: "<a:disponible:605932681527689236>``g!new``\ **Créé un ticket de support\n<a:disponible:605932681527689236>``g!verif``\ Vous permet de verifier si l'utilisateur mentionné est dans le staff du bot\n<a:disponible:605932681527689236>``g!gen``\ Vous permet de générer une invitation permanente!\n <a:disponible:605932681527689236>``g!avatar``\ Vous donne la photo de profil de la personne mentionné !\n<a:disponible:605932681527689236>``g!uptime``\ Voir depuis quand le bot ne c'est pas redémarré\n<a:disponible:605932681527689236>``g!ping``\ Regarder le ping du bot\n<a:disponible:605932681527689236>``g!setup``\ Vous permet de voir comment construire votre serveur\n<a:disponible:605932681527689236>``g!view``\ Vous permet d'avoir la liste de 5 serveurs qui sont là pour exemple des commandes\n<a:disponible:605932681527689236>``g!contact``\ faire un report ou autre en contactant un administrateur rapidemment (réponse sous 24h)**"
...
client.login("NTIwMzIyNDA1OTgyNTM1NzA1.XVIOIw.fC1W5mhDx5Sd6JRv_Go8PovGioU")
